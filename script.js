document.addEventListener('DOMContentLoaded', function () {
  ...
  const scrollElements = document.querySelectorAll(
    '.fade-in, .animate-on-scroll, [data-animate], .section-content, .feature-card, .pricing-card, .testimonial-card, .team-member, .service-item, .portfolio-item, .hero-content'
  );
  ...
  if (!document.getElementById(styleId)) {
    ...
    style.textContent = [
      ...
      '}',
      '.' + observerTargetClass + '.' + animationClass + ' {',
      '  opacity: 1;',
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'cd7f026f-eeeb-44ea-b0d6-9aac54a6c8b9',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'cd7f026f-eeeb-44ea-b0d6-9aac54a6c8b9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'cd7f026f-eeeb-44ea-b0d6-9aac54a6c8b9';
